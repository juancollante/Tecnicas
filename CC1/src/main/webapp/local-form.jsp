...
<body>
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.javaguides.net" class="navbar-brand"> Administrador de Locales </a>
			</div>
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<c:if test="${local != null}">
					<input type="hidden" name="numero" value="<c:out value='${local.numero}' />" />
				</c:if>

				<fieldset class="form-group">
					<label>Nombre del local</label> <input type="text"
